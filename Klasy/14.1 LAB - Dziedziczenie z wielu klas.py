...
class PromoCake(Cake,Promo):
    # aby obejść możliwy konflikt przy takiej samej nazwie zmiennych w 2 klasach rodzica 'name' w init można przypisać zmienną jako odwołanie do klasy
    # a następnie wywołując rodzica przez init przed każdym parametrem dodać włąśnie odwołanie do klasy
