...
Cake.export_1_cake_to_html(cake01, r'c:/temp/cake01.html')
...
for c in Cake.bakery_offer:
    c.export_this_cake_to_html('c:/temp/{}.html'.format(c.name.replace(' ','_')))
